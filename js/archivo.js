...
function carga() {
  ...
  document.getElementById("demo").innerHTML =
    "Muchas gracias. El formulario se ha enviado con exito.";
}
...
function mostrar() {
  elementos = document.querySelectorAll(
    ".datos[name=op1], .datos[name=op2], .datos[name=op3]"
  );
...
function mostrar_mod1() {
  elementos = document.querySelectorAll(
    ".cambio_correo[name=actual_correo], .cambio_correo[name=newcorreo]"
  );
  for (var i = 0; i < elementos.length; i++) {
    elementos[i].disabled = false;
...
function mostrar_mod2() {
  elementos = document.querySelectorAll(
    ".cambio_contra[name=actual_contra], .cambio_contra[name=newcontra]"
  );
  for (var i = 0; i < elementos.length; i++) {
    elementos[i].disabled = false;
...
function mostrar_mod3() {
  elementos = document.querySelectorAll(
    ".cambio_cel[name=actual_cel], .cambio_cel[name=newcelular]"
  );
  for (var i = 0; i < elementos.length; i++) {
    elementos[i].disabled = false;
